...
# Make custom login page the default
def rootredirect(request):
    return redirect('custom-login/')

urlpatterns = [
    # Default root redirects to custom login page
    path('', rootredirect, name='root'),
    
    path('admin/', admin.site.urls),
    path('base/', views.BASE,name='base'),

    # Custom login path (accessible via /login/ or /custom-login/)
    path('custom-login/',views.LOGIN,name='login'),
